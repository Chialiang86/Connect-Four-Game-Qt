...
void hard::display(vector<vector<int> > board) {
...
bool hard::drawj(vector<vector<int> > board) {
...
float hard::value(vector<vector<int> > board) {
...
float hard::value1(vector<vector<int> > board) {
...
void hard::findposmove(vector<vector<int> > board, int* simboard1) {
...
void hard::setorback(vector<vector<int> > &board, int dep, int *simboard, int choice) {//-1 set 0 back
...
float hard::dfsuntil(vector<vector<int> > board, int dep) {
...
int hard::ai(vector<vector<char> > board, char mydisc, char oppdisc) {
...
int hard::hard_ai(const vector < vector<char> > &b, char mydisc, char yourdisc) {
